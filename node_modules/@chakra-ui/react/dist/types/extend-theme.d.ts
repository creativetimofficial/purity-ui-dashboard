 ...
 * )
 */
export declare function extendTheme<BaseTheme extends ChakraTheme = Theme, Extensions extends (BaseTheme | ThemeOverride<BaseTheme> | ThemeExtension<ThemeOverride<BaseTheme>>)[] = (ThemeOverride<BaseTheme> | ThemeExtension<ThemeOverride<BaseTheme>>)[]>(...extensions: [...Extensions]): BaseThemeWithExtensions<BaseTheme, Extensions>;
export declare function mergeThemeOverride<BaseTheme extends ChakraTheme = ChakraTheme>(...overrides: ThemeOverride<BaseTheme>[]): ThemeOverride<BaseTheme>;
export {};
