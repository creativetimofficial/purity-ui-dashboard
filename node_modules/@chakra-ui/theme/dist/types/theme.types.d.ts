...
export interface ThemeComponentProps<Theme extends ChakraTheme = ChakraTheme> extends Dict, Omit<ThemingProps, "styleConfig"> {
    colorMode: ColorMode;
    theme: Theme;
}
export declare type ThemeComponentFunction<Style, Theme extends ChakraTheme = ChakraTheme> = (props: ThemeComponentProps<Theme>) => Style;
export declare type ThemingPropsThunk<Style, Theme extends ChakraTheme = ChakraTheme> = Style | ThemeComponentFunction<Style, Theme>;
