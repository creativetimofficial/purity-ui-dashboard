          ...
          <DrawerBody w="340px" ps="24px" pe="40px">
            <Flex flexDirection="column">
              ...
              <Box mt="24px">
                ...
                <Box>
                  <Link
                    href="https://www.creative-tim.com/product/purity-ui-dashboard?ref=creativetim-vud"
                    w="100%"
                    mb="16px"
                  >
                    <Button
                  ...
                  <Link
                    href="https://demos.creative-tim.com/docs-purity-ui-dashboard/?ref=creativetim-vud"
                    w="100%"
                  >
                    <Button
                      w="100%"
